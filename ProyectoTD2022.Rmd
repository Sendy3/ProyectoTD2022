...
1. ¿En que año hubo más ruido por la noche? ¿Y por el día?
2. ¿Que meses de cada año fueron los más ruidosos?
3. ¿Que día es el más ruidoso en fallas de cada año?(2021,2022)
4. ¿Que porcentaje de ruido ha aumentado el mes más ruidoso de 2021 en comparación con el mes anterior?
5. ¿Que calle es la más ruidosa?
  5.1.¿Como se diferencia de la calle menos ruidosa?
6. 
7. ¿Hay más ruido en verano o en invierno?
...
ggplot(data=dd0, aes(x=mes, y=promedio_mensual,  color = anyo)) + geom_line(linetype = "dashed")+ geom_point(size = 5, shape = 18)+ylab("Promedio mensual de sonido")+ xlab("Meses")+ theme(axis.title=element_text(size=10,face="italic"))  + theme(legend.position="bottom") + ggtitle("Promedio mensual por el dia") + scale_x_continuous(breaks=seq(1,12))+ geom_hline(yintercept = limdia, color = "darkred", show.legend = TRUE, linetype = "dashed")
...
ggplot(data=dd0, aes(x=mes, y=promedio_mensual,  color = anyo)) + geom_line(linetype = "dashed")+ geom_point(size = 5, shape = 18)+ylab("Promedio mensual de sonido ")+ xlab("Meses")+ theme(axis.title=element_text(size=10,face="italic"))  + theme(legend.position="bottom") + ggtitle("Promedio mensual por la noche ") + scale_x_continuous(breaks=seq(1,12))
...
## 4. ¿Que porcentaje de ruido ha aumentado el mes mas ruidoso de 2021 en comparacion con el mes anterior?
